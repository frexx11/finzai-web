    ...
    <section className="relative min-h-screen overflow-hidden pt-20 flex flex-col items-center justify-center">
      ...
      <div className="container relative z-[2] mx-auto flex min-h-[calc(100vh-5rem)] flex-col items-center justify-center px-6">
        ...
        >
          ...
          >
            A proactive AI agent that understands your profile, 
            monitors the market, and delivers personalized investment insights 
            directly to you.
          </motion.p>
          ...
          {isSuccess ? (
            ...
            <motion.form
              ...
              className="mx-auto mt-12 flex w-full max-w-md flex-col gap-3 sm:flex-row relative z-10"
            >
